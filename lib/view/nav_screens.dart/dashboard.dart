...
import '../../widgets/tab_widgets/coins_tab.dart';
              ...
              child: Obx(() => Column(children: [
                    Row(children: [
                      ...
                      GestureDetector(
                          ...
                          child: Icon(
                              isVisible.value ? Iconsax.eye : Iconsax.eye_slash,
                              color: Colors.grey,
                              size: 25.sp))
                    ]),
                    Gap(5.h),
                          ...
                          child: ListView.separated(
                              ...
                              itemBuilder: (context, i) {
                                return DashboardCard(
                                    surfaceTint: dashboardCard[i]
                                        ['surfaceTint'],
                                    containerColor: dashboardCard[i]
                                        ['surfaceTint']);
                              },
...
List<Widget> _tabsBody = [
  ListView.builder(
      ...
      itemCount: 8),
  const ListTile(title: CircleAvatar(backgroundColor: Colors.yellow)),
  const ListTile(title: CircleAvatar(backgroundColor: Colors.blue)),
];
